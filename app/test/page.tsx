...
const BOX_STYLE =
  "z-20 transition-color text-gray-100 ease-in-out border border-neutral-500 hover:border-slate-100 bg-zinc-900/70 duration-200 rounded-lg";
      ...
      <div className="z-10 area flex">
        ...
        <main className="flex-col justify-between overflow-auto">
          <Transition show={true} appear={true}>
            <div
              className={`min-h-full grid grid-cols-4 lg:grid-rows-7 gap-4 py-6 px-6 lg:px-36 2xl:px-72`}
            >
