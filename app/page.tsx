  ...
  return (
    <>
      ...
      <div className="z-10 area flex">
        <main className="justify-between flex flex-col min-h-screen">
          <Transition show={true} appear={true}>
            <FadeAndSlide delay="delay-[0ms]">
              <header className="flex-shrink-0">
                <h1 className="py-2 lg:py-4 px-2 lg:px-4 xl:px-36 font-[100] text-2xl lg:text-4xl drop-shadow-[5px_5px_7px_rgba(0,0,0,0.99)] lg:drop-shadow-[5px_5px_10px_rgba(0,0,0,0.99)] text-transparent bg-clip-text bg-white">
            ...
            <div
              className={`max-h-full overflow-auto grid grid-cols-4 lg:grid-rows-7 gap-2 p-2 lg:gap-4 lg:p-4 xl:px-36`}
            >
              <MainComponent />
