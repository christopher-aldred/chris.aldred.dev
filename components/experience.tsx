...
export default function Experience() {
  return (
    <FadeAndSlide delay="delay-[700ms]">
      ...
      >
        <div className="grid h-full grid-cols-2 grid-rows-2 divide-dashed divide-y-2 divide-x-2 divide-slate-400/25 [clip-path:inset(theme(divideWidth.2)_0_0_theme(divideWidth.2))] prevent-select">
          <div className="group p-6 flex flex-col justify-between text-center">
            <div className="text-5xl group-hover:text-[#fede59]">7+</div>
            <div className="text-xs font-[250] text-slate-400 group-hover:text-[#fede59]">
              Years
            </div>
            <div className="text-xs font-[250] text-slate-400 group-hover:text-[#fede59]">
              experience
