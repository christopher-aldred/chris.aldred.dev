...
export default function MainComponent() {
  return (
    <FadeAndSlide delay="delay-[100ms]">
      <div
        className={`text-[16px] font-[200] col-span-4 lg:col-span-3 row-span-3 p-4 lg:p-6 custom-box-style min-h-80`}
      >
        <div className="h-full w-full grid grid-cols-3 lg:grid-rows-2 gap-0">
          <div className="col-span-3 lg:col-span-2 row-start-1 min-h-28">
            ...
            I'm <b>Chris</b>, a web developer with a passion for
            ...
            open to new opportunities. If you need a developer let’s connect,
            book a call or get in touch below.
          </div>
          <div className="col-span-2 col-start-1 row-start-2 flex items-end flex-wrap h-auto mt-4">
            ...
            >
              ...
              <span className="h-10 w-[106px] lg:h-12 lg:w-32 text-md lg:text-lg flex flex-col justify-center items-center fold-bold relative  rounded-lg border border-white bg-neutral-900 px-3 py-1 font-[200] text-white transition duration-100 hover:bg-[#fede59] hover:text-gray-900 hover:border-[#fede59] ml-1 mb-1">
                Book a call
              </span>
            </Link>
